...
void function () {
  var _, addSiblings, biggestTitleChunk, cleanText, cleanTitle, definitions, formatter, generateCandidates, getFirstNonEmptyCandidate, getObjectTag, getScore, getSiblingsContent, getSiblingsScore, getVideoAttrs, isBoostable, isHighlinkDensity, isNodescoreThresholdMet, isTableAndNoParaExist, postCleanup, rawTitle, stopwords, updateNodeCount, updateScore;
  _ = require('lodash');
  ...
  getFirstNonEmptyCandidate = function (candidates) {
    ...
    _.each(definitions[key], function (selector) {
      return _.each(selector.elements, function (e) {
        ...
        if (!(selector.selectors || selector.attributes))
          queries.push(null != dom ? dom.text() : void 0);
        _.each(selector.attributes, function (a) {
          if (!selector.selectors)
            return queries.push(null != dom ? dom.attr(a) : void 0);
        });
