...
void function () {
  var _, addSiblings, biggestTitleChunk, calculateBestNode, canonicalLink, cheerio, cleaner, description, extractor, extractTags, favicon, formatter, getObjectTag, getScore, getSiblingsContent, getSiblingsScore, getVideoAttrs, isBoostable, isHighlinkDensity, isNodescoreThresholdMet, isTableAndNoParaExist, keywords, lang, postCleanup, stopwords, text, title, updateNodeCount, updateScore, videos;
