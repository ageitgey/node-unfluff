...
void function () {
  var _, addSiblings, biggestTitleChunk, domainsExtractor, formatter, getObjectTag, getScore, getSiblingsContent, getSiblingsScore, getVideoAttrs, isBoostable, isHighlinkDensity, isNodescoreThresholdMet, isTableAndNoParaExist, postCleanup, stopwords, updateNodeCount, updateScore;
  _ = require('lodash');
  stopwords = require('./stopwords');
  formatter = require('./formatter');
  domainsExtractor = require('./domainExtractor');
  module.exports = {
    title: function (doc, url) {
      var domainExtractor, title, titleElement, titleText, usedDelimeter;
      if (url) {
        domainExtractor = domainsExtractor(url);
        if (domainExtractor && domainExtractor.title !== void 0) {
    ...
    image: function (doc, url) {
      var domainExtractor, image, images;
      if (url) {
        domainExtractor = domainsExtractor(url);
        if (domainExtractor && domainExtractor.image !== void 0) {
