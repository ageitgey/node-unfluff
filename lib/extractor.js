...
void function () {
  ...
  module.exports = {
    date: function (doc) {
      ...
      dateCandidates = doc("meta[property='article:published_time'],     meta[itemprop*='datePublished'], meta[name='dcterms.modified'],     meta[name='dcterms.date'],     meta[name='DC.date.issued'],  meta[name='dc.date.issued'],     meta[name='dc.date.modified'], meta[name='dc.date.created'],     meta[name='DC.date'],     meta[name='DC.Date'],     meta[name='dc.date'],     meta[name*='date'],     time[itemprop='pubDate'],     time[itemprop='pubdate'],     span[property*='datePublished'],     p[property*='datePublished'],     div[property*='datePublished'],     li[property*='datePublished'],     time,     div[class*='date'],     p[class*='date'],     span[class*='date']");
    ...
    author: function (doc) {
      var authorCandidates, authorList, cache$, cache$1, fallbackAuthor;
      authorCandidates = doc("meta[property='article:author'],     meta[property='og:article:author'], meta[name='author'],     meta[name='dcterms.creator'],     meta[name='DC.creator'],     meta[name='DC.Creator'],     meta[name='dc.creator'],     meta[name='creator'], meta[property='og:site_name']");
      authorList = [];
      ...
      if (!authorList) {
        fallbackAuthor = (null != (cache$ = doc("span[class*='author']").first()) ? cache$.text() : void 0) || (null != (cache$1 = doc("p[class*='author']").first()) ? cache$1.text() : void 0);
