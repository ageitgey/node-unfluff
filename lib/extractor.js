...
void function () {
  ...
  module.exports = {
    date: function (doc) {
      ...
      dateCandidates = doc("meta[property='article:published_time'],     meta[itemprop*='datePublished'], meta[name='dcterms.modified'],     meta[name='dcterms.date'],     meta[name='DC.date.issued'],  meta[name='dc.date.issued'],     meta[name='dc.date.modified'], meta[name='dc.date.created'],     meta[name='DC.date'],     meta[name='dc.date'],     meta[name*='date'],     time[itemprop='pubDate'],     time[itemprop='pubdate'],     span[property*='datePublished'],     p[property*='datePublished'],     div[property*='datePublished'],     li[property*='datePublished'],     time,     div[class*='date'],     p[class*='date'],     span[class*='date']");
      return (null != dateCandidates && null != (cache$ = dateCandidates.first()) && null != (cache$1 = cache$.attr('content')) ? cache$1.trim() : void 0) || (null != dateCandidates && null != (cache$2 = dateCandidates.first()) && null != (cache$3 = cache$2.attr('datetime')) ? cache$3.trim() : void 0) || cleanText(null != dateCandidates && null != (cache$4 = dateCandidates.first()) ? cache$4.text() : void 0);
    },
    copyright: function (doc) {
      var cache$, copyright, copyrightCandidates;
      ...
      copyright = null != copyrightCandidates && null != (cache$ = copyrightCandidates.first()) ? cache$.text() : void 0;
      return cleanText(copyright);
    },
    author: function (doc) {
      var authorCandidates, authorList, cache$, fallbackAuthor;
      authorCandidates = doc("meta[property='article:author'],     meta[property='og:article:author'], meta[name='author'],     meta[name='dcterms.creator'],     meta[name='DC.creator'],     meta[name='dc.creator'],     meta[name='creator'], meta[property='og:site_name']");
      authorList = [];
      authorCandidates.each(function () {
        var author, cache$;
        author = null != (cache$ = doc(this).attr('content')) ? cache$.trim() : void 0;
        if (author)
          return authorList.push(author);
      });
      if (!authorList) {
        fallbackAuthor = null != (cache$ = doc("div[class*='author']").first()) ? cache$.text() : void 0;
