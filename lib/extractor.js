...
void function () {
  ...
  module.exports = {
    ...
    author: function (doc) {
      var authorCandidates, authorList, cache$, cache$1, cache$2, fallbackAuthor;
      ...
      if (!authorList) {
        fallbackAuthor = (null != (cache$ = doc("span[class*='author']").first()) ? cache$.text() : void 0) || (null != (cache$1 = doc("p[class*='author']").first()) ? cache$1.text() : void 0) || (null != (cache$2 = doc("div[class*='author']").first()) ? cache$2.text() : void 0);
