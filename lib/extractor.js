...
void function () {
  var _, addSiblings, biggestTitleChunk, calculateBestNode, canonicalLink, cheerio, cleaner, description, extractor, extractTags, favicon, formatter, getScore, getSiblingsContent, getSiblingsScore, isBoostable, isHighlinkDensity, isNodescoreThresholdMet, isTableAndNoParaExist, keywords, lang, postCleanup, stopwords, text, title, updateNodeCount, updateScore;
